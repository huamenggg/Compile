...
{
       0,    70,    70,    76,    83,    85,    94,   102,   118,   122,
     135,   142,   147,   161,   177,   184,   186,   196,   203,   229,
     242,   268,   278,   283,   294,   319,   327,   329,   338,   343,
     354,   368,   385,   415,   423,   425,   443,   447,   458,   462,
     476,   486,   496,   506,   516,   526,   536,   546,   556,   567,
     576,   585,   598,   610,   628,   639,   647,   656,   680,   690
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SEMI", "COMMA", "RELOP", "ASSIGNOP", "ID", "TYPE", "START",
...
{
      17,   -23,   -88,    38,   -88,    17,   -13,   -88,    27,    41,
     -88,   -88,   -88,   -88,    30,    43,    26,    49,    17,    15,
     -88,    67,    42,    17,   -88,    42,    52,    17,   -88,    42,
      58,    50,    59,   -88,   -88,    36,   -11,    62,    65,   -88,
     -88,    77,   -88,    17,   -88,   -88,   -88,    61,    61,    61,
      61,    81,    82,    83,   -88,    79,    36,    73,    61,   -88,
      42,   -88,    78,     0,    97,   108,    61,    61,    48,   -88,
     -88,    61,    61,    61,    61,    61,    61,    70,    61,   -88,
      61,    61,   185,   -88,   -88,   -88,   132,   143,   -88,   157,
      95,    78,    78,   185,     0,   209,   196,   -88,   171,   220,
     185,    36,    36,    61,   -88,   -88,    88,   -88,   -88,    36,
     -88
};
...
{
     -88,   -88,   116,   -88,   100,     4,   -88,   -88,   -88,   -19,
     -88,    80,   -88,   110,    72,   -87,     9,   -88,    69,   -88,
     -47,    28
};
...
static const yytype_int8 yytable[] =
{
      ...
      28,    98,    35,    99,   100,     1,    40,     1,    11,    45,
      46,    36,    21,    47,    19,   -14,     2,    29,     2,    48,
      49,    45,    46,    22,    23,    47,    89,    50,    51,    18,
      52,    48,    49,    88,    45,    46,    53,    23,    47,    20,
      32,    39,    33,    42,    48,    49,    44,    43,    53,    71,
      72,    73,    74,    75,    76,    77,    73,    74,    59,    78,
      77,    53,    60,    21,    78,    66,    67,    68,    69,    79,
      97,    80,    81,    71,    72,    73,    74,    75,    76,    77,
     104,   109,    84,    78,    71,    72,    73,    74,    75,    76,
      77,    12,    34,    61,    78,    80,    81,    24,    70,    83,
       0,   108,     0,     0,    85,     0,    80,    81,    71,    72,
      73,    74,    75,    76,    77,     0,     0,   101,    78,    71,
      72,    73,    74,    75,    76,    77,     0,     0,   102,    78,
      80,    81,     0,    71,    72,    73,    74,    75,    76,    77,
       0,    80,    81,    78,     0,     0,     0,    71,    72,    73,
      74,    75,    76,    77,   103,    80,    81,    78,   105,     0,
       0,    71,    72,    73,    74,    75,    76,    77,     0,    80,
      81,    78,    71,    72,    73,    74,    75,     0,    77,     0,
       0,     0,    78,    80,    81,    71,    72,    73,    74,     0,
       0,    77,     0,     0,    80,    78,    71,    72,    73,    74,
       0,     0,    77,     0,     0,     0,    78,    80
};

static const yytype_int8 yycheck[] =
{
      47,    48,    49,    50,     0,    16,    25,    30,     8,     5,
      29,    58,    12,    26,   101,   102,    16,    30,    29,    66,
      67,    68,   109,    19,    71,    72,    73,    74,    75,    76,
      15,    78,    23,    80,    81,    20,    27,    20,     0,     3,
       4,    60,    16,     7,    14,    18,    31,    43,    31,    13,
      14,     3,     4,    27,    18,     7,   103,    21,    22,    18,
      24,    13,    14,    15,     3,     4,    30,    18,     7,    26,
       3,    19,    30,    15,    13,    14,    17,    27,    30,     6,
       7,     8,     9,    10,    11,    12,     8,     9,    26,    16,
      12,    30,    27,    16,    16,    14,    14,    14,    19,    26,
      30,    28,    29,     6,     7,     8,     9,    10,    11,    12,
      15,    23,    15,    16,     6,     7,     8,     9,    10,    11,
      12,     5,    22,    43,    16,    28,    29,    17,    56,    60,
      -1,   103,    -1,    -1,    26,    -1,    28,    29,     6,     7,
       8,     9,    10,    11,    12,    -1,    -1,    15,    16,     6,
       7,     8,     9,    10,    11,    12,    -1,    -1,    15,    16,
      28,    29,    -1,     6,     7,     8,     9,    10,    11,    12,
      -1,    28,    29,    16,    -1,    -1,    -1,     6,     7,     8,
       9,    10,    11,    12,    27,    28,    29,    16,    17,    -1,
      -1,     6,     7,     8,     9,    10,    11,    12,    -1,    28,
      29,    16,     6,     7,     8,     9,    10,    -1,    12,    -1,
      -1,    -1,    16,    28,    29,     6,     7,     8,     9,    -1,
      -1,    12,    -1,    -1,    28,    16,     6,     7,     8,     9,
      -1,    -1,    12,    -1,    -1,    -1,    16,    28
};
...
{
       0,    20,    31,    35,    36,    37,    39,    40,    30,    41,
      42,     0,    36,    26,    30,    38,    43,    44,    18,    14,
      26,    16,    27,    18,    47,    39,    50,    51,    15,    39,
      45,    46,     3,    30,    38,    50,    43,    52,    53,    19,
      50,    43,    15,    27,    17,     3,     4,     7,    13,    14,
      21,    22,    24,    30,    47,    48,    49,    54,    29,    26,
      27,    45,    54,    54,    54,    54,    14,    14,    14,    19,
      48,     6,     7,     8,     9,    10,    11,    12,    16,    26,
      28,    29,    54,    52,    15,    26,    54,    54,    15,    54,
      55,    54,    54,    54,    54,    54,    54,    30,    54,    54,
      54,    15,    15,    27,    15,    17,    49,    49,    55,    23,
      49
};
...
#line 178 "./syntax.y" /* yacc.c:1646  */
    {
		struct Node* p = (struct Node*)malloc(sizeof(struct Node));
		p = CreateTerminal("ID", Id, (yyvsp[0].type_char), 0,
				(yylsp[0]).first_line, 0);
...
#line 230 "./syntax.y" /* yacc.c:1646  */
    {
		...
		child[0] = CreateTerminal("ID", Id,
				(yyvsp[-3].type_char), 0, (yylsp[-3]).first_line, 0);
...
#line 243 "./syntax.y" /* yacc.c:1646  */
    {
		struct Node* child[3];
		child[0] = CreateTerminal("ID", Id,
				(yyvsp[-2].type_char), 0, (yylsp[-2]).first_line, 0);
		child[1] = CreateTerminal("LP", Terminal,
...
#line 629 "./syntax.y" /* yacc.c:1646  */
    {
		...
		child[2] = CreateTerminal("ID", Id,
				(yyvsp[0].type_char), 0, (yylsp[0]).first_line, 0);
		(yyval.type_node) = CreateVariable("Exp", 3, child,
				(yyloc).first_line);
	}
